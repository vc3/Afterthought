...
namespace Microsoft.Cci.MutableCodeModel
{
    ...
    public sealed class MethodImplementation : IMethodImplementation, ICopyFrom<IMethodImplementation>
    {
        ...
        {
            if (obj != null && obj is MethodImplementation)
            {
                var m= obj as MethodImplementation;
                return this.ContainingType == m.ContainingType
                    && this.implementedMethod == m.implementedMethod
                    && this.ImplementingMethod == m.ImplementingMethod;
        ...
        {
            return this.containingType.GetHashCode()*
                this.implementedMethod.GetHashCode()*
                this.implementingMethod.GetHashCode();
        }
